...
$dictionary["jump_quote_jump_autofinancing_1"] = array (
  ...
  'table' => 'jump_quote_jump_autofinancing_1_c',
  'fields' => 
  array (
    0 => 
    array (
    ...
    4 => 
    array (
      'name' => 'jump_quote_jump_autofinancing_1jump_autofinancing_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    0 => 
    array (
      'name' => 'jump_quote_jump_autofinancing_1spk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    1 => 
    array (
      'name' => 'jump_quote_jump_autofinancing_1_ida1',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'jump_quote_jump_autofinancing_1jump_quote_ida',
      ),
    ),
    2 => 
    array (
      'name' => 'jump_quote_jump_autofinancing_1_alt',
      'type' => 'alternate_key',
      'fields' => 
      array (
        0 => 'jump_quote_jump_autofinancing_1jump_autofinancing_idb',
      ),
    ),
  ),
);