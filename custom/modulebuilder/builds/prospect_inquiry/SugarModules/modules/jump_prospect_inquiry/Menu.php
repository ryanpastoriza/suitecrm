...
if(ACLController::checkAccess('jump_prospect_inquiry', 'edit', true)){
    $module_menu[]=array('index.php?module=jump_prospect_inquiry&action=EditView&return_module=jump_prospect_inquiry&return_action=DetailView', $mod_strings['LNK_NEW_RECORD'], 'Add', 'jump_prospect_inquiry');
}
